...
def oh_my_teacher():
    ...
    if request.method == 'POST':
        ...
        summary_caption_gpt = summaryGPT(cleaned_input)
    ...
    # return jsonify(data)
    return render_template('template.html', caption=caption, summary=summary_caption, summaryGPT=summary_caption_gpt)
...
def summaryGPT(caption):
    ...
    completion = client.chat.completions.create(
        ...
        messages=[
            {"role": "system", "content": ""},
            {"role": "user", "content": "ช่วยสรุป '" + caption + "'"}
        ]
    )
